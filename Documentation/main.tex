...
Object detection being used in a wide range of domains, from face recognition to tracking a ball in a football match, developing computationally fast and cheap methods is critical to the improvement of the said domains. The Faster R-CNN of Ren et al. achieves 73.2\% \emph{mean Average Precision} (mAP) on PASCAL VOC 2007 and 70.4\% mAP on PASCAL VOC 2012 \cite{fasterrcnn}. It is a net improvement over the earlier methods, with the R-CNN fc$_7$ of Girshick et al. (2014) going up to 48\% mAP on PASCAL VOC 2007 and 43.5\% on 2010 \cite{rcnn}, the (HZRS's) SPPnet of He et al. achieving 35.11\% mAP on ILSVRC 2014, and the Fast R-CNN of Girshick with VGG16 reaching 66.9\% mAP on PASCAL VOC 2007.
